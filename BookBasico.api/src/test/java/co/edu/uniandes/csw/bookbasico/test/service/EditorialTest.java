...
public class EditorialTest {
    ...
    @Test
    public void t1CreateEditorialTest() throws IOException {
    ...
    @Test
    public void t3EditorialTest() throws IOException {
        Cookie cookieSessionId = login(username, password);
        Response response = target.path(editorialPath)
    ...
    @Test
    public void t4UpdateEditorialTest() throws IOException {
        Cookie cookieSessionId = login(username, password);
        EditorialDTO editorial = oraculo.get(0);
        PodamFactory factory = new PodamFactoryImpl();
    ...
    @Test
    public void t5AddBookEditorialTest() {
    ...
    @Test
    public void t8RemoveBookEditorialTest() {
        Cookie cookieSessionId = login(System.getenv("USERNAME_USER"), System.getenv("PASSWORD_USER"));
    ...
    @Test
    public void t9DeleteEditorialTest() {
        Cookie cookieSessionId = login(System.getenv("USERNAME_USER"), System.getenv("PASSWORD_USER"));
        EditorialDTO editorial = oraculo.get(0);
        Response response = target.path(editorialPath).path(editorial.getId().toString())
                .request().cookie(cookieSessionId).delete();
